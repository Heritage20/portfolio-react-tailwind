  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
      ...
      >
        ...
        <p className="mt-10">
          Voluptates, iure mollitia minima, tempore sint esse quis maxime neque
          optio dignissimos numquam. Recusandae ex eaque dolores beatae.
        </p>
      </motion.div>
      ...
      <div className="md:flex md:justify-between gap-8">
        ...
        >
          ...
          <p className="text-xl text-center">
            Consectetur vel, repellendus dolore quibusdam blanditiis enim mag.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <p className="font-playfair text-6xl">"</p>
          <p className="text-xl text-center">
            Architecto accusamus est officia fuga iusto, nihil porro rem ipsa.
          </p>
        </motion.div>
      </div>
    </section>
